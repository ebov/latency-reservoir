...
The root proposed above had the highest posterior support (70.0\%) of all root positions with the remaining support split between trees with the Gabon/2001-RoC/2003 clade or the Kasa{\"i}/2007-Kasa{\"i}/2008 cade as outgroups (Figure~\ref{fig:scNmBEAST} and Supplemental Figure~\ref{fig:nMallRoots}).
